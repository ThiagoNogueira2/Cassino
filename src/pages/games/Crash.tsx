...
import { mockCrashHistory, mockChatMessages } from "@/mock/data";
import { useToast } from "@/hooks/use-toast";

type GamePhase = "waiting" | "flying" | "crashed";

function CrashCanvas({ multiplier, crashed, phase }: { multiplier: number; crashed: boolean; phase: GamePhase }) {
...
export default function CrashGame() {
  ...
  const [history, setHistory] = useState(mockCrashHistory);
