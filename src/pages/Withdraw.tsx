...
export default function WithdrawPage() {
  ...
  const handleWithdraw = () => {
    ...
    if (!amount || Number(amount) < 20) { toast({ title: "Mínimo R$20", variant: "destructive" }); return; }
            ...
            {step === "form" && (
              <div className="p-6 space-y-5">
                <div>
                  ...
                  <Input type="number" placeholder="Mínimo R$20" className="bg-secondary border-border text-lg font-bold" value={amount} onChange={(e) => setAmount(Number(e.target.value) || "")} />
